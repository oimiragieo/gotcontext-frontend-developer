...
description: Adapter pointer to canonical skills/mengto-funky-purple-container-tech for Claude Code
---

# mengto-funky-purple-container-tech (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-funky-purple-container-tech/SKILL.md`](../../../skills/mengto-funky-purple-container-tech/SKILL.md)
