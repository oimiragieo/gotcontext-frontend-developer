...
description: Adapter pointer to canonical skills/mengto-scroll-scrubbed-visual-sequence for Claude Code
---

# mengto-scroll-scrubbed-visual-sequence (Claude Code adapter)
