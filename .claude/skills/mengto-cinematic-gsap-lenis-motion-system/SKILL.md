...
description: Adapter pointer to canonical skills/mengto-cinematic-gsap-lenis-motion-system for Claude Code
---

# mengto-cinematic-gsap-lenis-motion-system (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-cinematic-gsap-lenis-motion-system/SKILL.md`](../../../skills/mengto-cinematic-gsap-lenis-motion-system/SKILL.md)
