...
description: Adapter pointer to canonical skills/sample-awesome-premium-frontend-ui for Claude Code
---

# sample-awesome-premium-frontend-ui (Claude Code adapter)

Canonical skill: [`../../../skills/sample-awesome-premium-frontend-ui/SKILL.md`](../../../skills/sample-awesome-premium-frontend-ui/SKILL.md)
