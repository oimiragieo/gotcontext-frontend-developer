---
name: sample-agents-react-native-design
description: Adapter pointer to canonical skills/sample-agents-react-native-design for Claude Code
---

# sample-agents-react-native-design (Claude Code adapter)

Canonical skill: [`../../../skills/sample-agents-react-native-design/SKILL.md`](../../../skills/sample-agents-react-native-design/SKILL.md)
