---
name: sample-agents-accessibility-compliance
description: Adapter pointer to canonical skills/sample-agents-accessibility-compliance for Claude Code
---

# sample-agents-accessibility-compliance (Claude Code adapter)

Canonical skill: [`../../../skills/sample-agents-accessibility-compliance/SKILL.md`](../../../skills/sample-agents-accessibility-compliance/SKILL.md)
