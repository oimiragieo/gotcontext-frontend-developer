---
name: sample-agents-mobile-android-design
description: Adapter pointer to canonical skills/sample-agents-mobile-android-design for Claude Code
---

# sample-agents-mobile-android-design (Claude Code adapter)

Canonical skill: [`../../../skills/sample-agents-mobile-android-design/SKILL.md`](../../../skills/sample-agents-mobile-android-design/SKILL.md)
