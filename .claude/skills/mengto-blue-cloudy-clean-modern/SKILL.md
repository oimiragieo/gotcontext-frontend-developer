---
name: mengto-blue-cloudy-clean-modern
description: Adapter pointer to canonical skills/mengto-blue-cloudy-clean-modern for Claude Code
---

# mengto-blue-cloudy-clean-modern (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-blue-cloudy-clean-modern/SKILL.md`](../../../skills/mengto-blue-cloudy-clean-modern/SKILL.md)
