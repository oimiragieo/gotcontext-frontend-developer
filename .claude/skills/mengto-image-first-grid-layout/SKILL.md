...
description: Adapter pointer to canonical skills/mengto-image-first-grid-layout for Claude Code
---

# mengto-image-first-grid-layout (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-image-first-grid-layout/SKILL.md`](../../../skills/mengto-image-first-grid-layout/SKILL.md)
