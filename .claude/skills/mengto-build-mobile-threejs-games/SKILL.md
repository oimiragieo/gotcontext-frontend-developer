...
description: Adapter pointer to canonical skills/mengto-build-mobile-threejs-games for Claude Code
---

# mengto-build-mobile-threejs-games (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-build-mobile-threejs-games/SKILL.md`](../../../skills/mengto-build-mobile-threejs-games/SKILL.md)
