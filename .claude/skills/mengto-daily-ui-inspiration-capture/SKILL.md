...
description: Adapter pointer to canonical skills/mengto-daily-ui-inspiration-capture for Claude Code
---

# mengto-daily-ui-inspiration-capture (Claude Code adapter)
