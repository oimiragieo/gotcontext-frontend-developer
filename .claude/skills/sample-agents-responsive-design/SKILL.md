---
name: sample-agents-responsive-design
description: Adapter pointer to canonical skills/sample-agents-responsive-design for Claude Code
---

# sample-agents-responsive-design (Claude Code adapter)

Canonical skill: [`../../../skills/sample-agents-responsive-design/SKILL.md`](../../../skills/sample-agents-responsive-design/SKILL.md)
