---
name: mengto-animation-systems
description: Adapter pointer to canonical skills/mengto-animation-systems for Claude Code
---

# mengto-animation-systems (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-animation-systems/SKILL.md`](../../../skills/mengto-animation-systems/SKILL.md)
