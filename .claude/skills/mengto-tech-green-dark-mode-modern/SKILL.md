...
description: Adapter pointer to canonical skills/mengto-tech-green-dark-mode-modern for Claude Code
---

# mengto-tech-green-dark-mode-modern (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-tech-green-dark-mode-modern/SKILL.md`](../../../skills/mengto-tech-green-dark-mode-modern/SKILL.md)
