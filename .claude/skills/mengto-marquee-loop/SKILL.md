...
description: Adapter pointer to canonical skills/mengto-marquee-loop for Claude Code
---

# mengto-marquee-loop (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-marquee-loop/SKILL.md`](../../../skills/mengto-marquee-loop/SKILL.md)
