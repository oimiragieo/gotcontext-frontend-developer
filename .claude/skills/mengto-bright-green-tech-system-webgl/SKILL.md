...
description: Adapter pointer to canonical skills/mengto-bright-green-tech-system-webgl for Claude Code
---

# mengto-bright-green-tech-system-webgl (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-bright-green-tech-system-webgl/SKILL.md`](../../../skills/mengto-bright-green-tech-system-webgl/SKILL.md)
