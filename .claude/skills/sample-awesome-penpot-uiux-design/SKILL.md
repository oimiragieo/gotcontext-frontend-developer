...
description: Adapter pointer to canonical skills/sample-awesome-penpot-uiux-design for Claude Code
---

# sample-awesome-penpot-uiux-design (Claude Code adapter)
