...
description: Adapter pointer to canonical skills/mengto-gooey-blob-system for Claude Code
---

# mengto-gooey-blob-system (Claude Code adapter)

Canonical skill: [`../../../skills/mengto-gooey-blob-system/SKILL.md`](../../../skills/mengto-gooey-blob-system/SKILL.md)
