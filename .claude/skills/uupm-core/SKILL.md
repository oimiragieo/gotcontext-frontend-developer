---
name: uupm-core
description: Adapter pointer to canonical skills/uupm-core for Claude Code
---

# uupm-core (Claude Code adapter)

Canonical skill: [`../../../skills/uupm-core/SKILL.md`](../../../skills/uupm-core/SKILL.md)
...
Imported from ui-ux-pro-max-skill-main. See upstream README for full behavior.
