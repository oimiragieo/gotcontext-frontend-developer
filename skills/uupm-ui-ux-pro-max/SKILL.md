...
**Install modes:** From this pack repo root (modes A/B), invoke the pack-relative path below. For user-global mode C, use `~/.claude/skills/uupm-ui-ux-pro-max/scripts/search.py` (or the Cursor equivalent under `~/.cursor/skills/`) — never `ui-ux-pro-max` without the `uupm-` prefix.
...
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<query>" --domain <domain>
```
...
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python skills/uupm-ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack>
```
...
python skills/uupm-ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python skills/uupm-ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux

# Step 4: stack guidelines
python skills/uupm-ui-ux-pro-max/scripts/search.py "suspense streaming bundle" --stack nextjs
```
