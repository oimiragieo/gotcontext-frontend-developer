...
From pack repo root (modes A/B): paths below. Mode C: `~/.claude/skills/uupm-design/scripts/...` (or `~/.cursor/skills/`).
...
python3 skills/uupm-design/scripts/cip/generate.py --brand "GreenLeaf" --logo logo.png --industry "organic food" --deliverables "letterhead,packaging,vehicle" --ratio 16:9
...
python3 skills/uupm-design/scripts/cip/render-html.py --brand "TopGroup" --industry "consulting" --images ./topgroup-cip --output presentation.html
```
