---
name: sample-agents-visual-design-foundations
description: Adapter pointer to canonical skills/sample-agents-visual-design-foundations for Cursor
---

# sample-agents-visual-design-foundations (Cursor adapter)

Canonical skill: [`../../../skills/sample-agents-visual-design-foundations/SKILL.md`](../../../skills/sample-agents-visual-design-foundations/SKILL.md)
