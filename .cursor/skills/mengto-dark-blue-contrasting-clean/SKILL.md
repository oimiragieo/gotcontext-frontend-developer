...
description: Adapter pointer to canonical skills/mengto-dark-blue-contrasting-clean for Cursor
---

# mengto-dark-blue-contrasting-clean (Cursor adapter)

Canonical skill: [`../../../skills/mengto-dark-blue-contrasting-clean/SKILL.md`](../../../skills/mengto-dark-blue-contrasting-clean/SKILL.md)
