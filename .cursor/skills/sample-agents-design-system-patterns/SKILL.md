---
name: sample-agents-design-system-patterns
description: Adapter pointer to canonical skills/sample-agents-design-system-patterns for Cursor
---

# sample-agents-design-system-patterns (Cursor adapter)

Canonical skill: [`../../../skills/sample-agents-design-system-patterns/SKILL.md`](../../../skills/sample-agents-design-system-patterns/SKILL.md)
