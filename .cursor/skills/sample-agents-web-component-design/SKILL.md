---
name: sample-agents-web-component-design
description: Adapter pointer to canonical skills/sample-agents-web-component-design for Cursor
---

# sample-agents-web-component-design (Cursor adapter)

Canonical skill: [`../../../skills/sample-agents-web-component-design/SKILL.md`](../../../skills/sample-agents-web-component-design/SKILL.md)
