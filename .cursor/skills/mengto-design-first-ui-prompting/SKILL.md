---
name: mengto-design-first-ui-prompting
description: Adapter pointer to canonical skills/mengto-design-first-ui-prompting for Cursor
---

# mengto-design-first-ui-prompting (Cursor adapter)

Canonical skill: [`../../../skills/mengto-design-first-ui-prompting/SKILL.md`](../../../skills/mengto-design-first-ui-prompting/SKILL.md)
