...
description: Adapter pointer to canonical skills/mengto-glass-dark-mode-clock for Cursor
---

# mengto-glass-dark-mode-clock (Cursor adapter)

Canonical skill: [`../../../skills/mengto-glass-dark-mode-clock/SKILL.md`](../../../skills/mengto-glass-dark-mode-clock/SKILL.md)
