---
name: sample-agents-mobile-ios-design
description: Adapter pointer to canonical skills/sample-agents-mobile-ios-design for Cursor
---

# sample-agents-mobile-ios-design (Cursor adapter)

Canonical skill: [`../../../skills/sample-agents-mobile-ios-design/SKILL.md`](../../../skills/sample-agents-mobile-ios-design/SKILL.md)
