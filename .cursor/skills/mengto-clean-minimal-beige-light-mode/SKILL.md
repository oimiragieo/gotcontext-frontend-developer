...
description: Adapter pointer to canonical skills/mengto-clean-minimal-beige-light-mode for Cursor
---

# mengto-clean-minimal-beige-light-mode (Cursor adapter)

Canonical skill: [`../../../skills/mengto-clean-minimal-beige-light-mode/SKILL.md`](../../../skills/mengto-clean-minimal-beige-light-mode/SKILL.md)
