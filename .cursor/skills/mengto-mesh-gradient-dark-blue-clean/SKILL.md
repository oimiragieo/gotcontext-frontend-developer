---
name: mengto-mesh-gradient-dark-blue-clean
description: Adapter pointer to canonical skills/mengto-mesh-gradient-dark-blue-clean for Cursor
---

# mengto-mesh-gradient-dark-blue-clean (Cursor adapter)

Canonical skill: [`../../../skills/mengto-mesh-gradient-dark-blue-clean/SKILL.md`](../../../skills/mengto-mesh-gradient-dark-blue-clean/SKILL.md)
