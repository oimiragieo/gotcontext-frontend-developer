...
description: Adapter pointer to canonical skills/mengto-atmosphere-background for Cursor
---

# mengto-atmosphere-background (Cursor adapter)

Canonical skill: [`../../../skills/mengto-atmosphere-background/SKILL.md`](../../../skills/mengto-atmosphere-background/SKILL.md)
