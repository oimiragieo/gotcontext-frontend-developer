---
name: mengto-light-mode-paper-technical
description: Adapter pointer to canonical skills/mengto-light-mode-paper-technical for Cursor
---

# mengto-light-mode-paper-technical (Cursor adapter)

Canonical skill: [`../../../skills/mengto-light-mode-paper-technical/SKILL.md`](../../../skills/mengto-light-mode-paper-technical/SKILL.md)
